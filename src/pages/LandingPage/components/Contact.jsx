    ...
    <div className={`${styles.paddingY}  text-center `}>
      ...
      <div className="py-8 lg:py-10 px-4 mx-auto md:flex flex-1 justify-between w-full">
          ...
          <form action="#" className="space-y-3  w-full">
            <div className="flex w-full space-x-5 justify-between">
              <div className="w-full">
                ...
                <input
                  type="text"
                  className="shadow-sm bg-gray-50 border border-gray-500 text-black text-sm rounded-lg focus:ring-primary-500  focus:border-primary-500 block w-full p-2.5"
                  placeholder="Kleber"
                  required
                />
              </div>
            ...
            <div className="sm:col-span-2 w-full">
              ...
              <textarea
                id="message"
                rows="6"
                className="block p-2.5 w-full text-sm text-black bg-gray-50 rounded-lg shadow-sm border border-gray-500 focus:ring-primary-500 focus:border-primary-500"
        ...
        <div className="w-full flex-col md:my-0 my-5 items-center ">
          ...
          <p className="font-extrabold text-white mt-3">+55 (31) 3247-3030</p>
        </div>
      </div>
    </div>
  );
